        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarServices_Cars_CarId1",
                        column: x => x.CarId1,
                        principalTable: "Cars",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarServices_Services_ServiceId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_CarServices_CarServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarServices_ServiceId1",
                table: "CarServices",
                column: "ServiceId1");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_CarServiceId",
                table: "Payments",
                column: "CarServiceId");
